...
public final class StatementTest_forEach {
    ...
    public Collection<? extends Result> forEach_Throughput(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_statementtest0_0.forEach(l_hrconnection2_2));
            }

            RawResults res = new RawResults(1L);
            forEach_Throughput_measurementLoop(control, res, l_hrconnection2_2, l_statementtest0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "forEach", res.getOperations(), res.getTime(), tu));
            return results;
        } else
    ...
    public void forEach_Throughput_measurementLoop(InfraControl control, RawResults result, HrConnection_1_jmh l_hrconnection2_2, StatementTest_1_jmh l_statementtest0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> forEach_AverageTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            StatementTest_1_jmh l_statementtest0_0 = _jmh_tryInit_f_statementtest0_0(control);
            HrConnection_1_jmh l_hrconnection2_2 = _jmh_tryInit_f_hrconnection2_2(control);
            ...
            RawResults res = new RawResults(1L);
            forEach_AverageTime_measurementLoop(control, res, l_hrconnection2_2, l_statementtest0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_statementtest0_0.forEach(l_hrconnection2_2));
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "forEach", res.getOperations(), res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void forEach_AverageTime_measurementLoop(InfraControl control, RawResults result, HrConnection_1_jmh l_hrconnection2_2, StatementTest_1_jmh l_statementtest0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> forEach_SampleTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            StatementTest_1_jmh l_statementtest0_0 = _jmh_tryInit_f_statementtest0_0(control);
            HrConnection_1_jmh l_hrconnection2_2 = _jmh_tryInit_f_hrconnection2_2(control);
            ...
            forEach_SampleTime_measurementLoop(control, buffer, targetSamples, l_hrconnection2_2, l_statementtest0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_statementtest0_0.forEach(l_hrconnection2_2));
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "forEach", buffer, tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void forEach_SampleTime_measurementLoop(InfraControl control, SampleBuffer buffer, int targetSamples, HrConnection_1_jmh l_hrconnection2_2, StatementTest_1_jmh l_statementtest0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public Collection<? extends Result> forEach_SingleShotTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        long realTime = 0;
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            StatementTest_1_jmh l_statementtest0_0 = _jmh_tryInit_f_statementtest0_0(control);
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SingleShotResult(ResultRole.PRIMARY, "forEach", (realTime > 0) ? realTime : (time2 - time1), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
